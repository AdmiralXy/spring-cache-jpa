...
subprojects {
    ...
    dependencies {
        ...
        compileOnly(rootProject.libs.jakarta.persistence)
        compileOnly(rootProject.libs.jakarta.annotations)

        testImplementation(rootProject.libs.jakarta.persistence)
        testImplementation(rootProject.libs.jakarta.annotations)
    }
}
