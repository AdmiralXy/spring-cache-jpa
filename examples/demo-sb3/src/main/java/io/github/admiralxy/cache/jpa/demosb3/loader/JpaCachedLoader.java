...
public class JpaCachedLoader implements CachedLoader {

    @Override
    @Cacheable(value = "jpa:testCache", key = "#id")
    public void loadValue(String id) {
        ...
        Holder holder = new Holder(Integer.parseInt(id), "This is a value for id = " + id);
